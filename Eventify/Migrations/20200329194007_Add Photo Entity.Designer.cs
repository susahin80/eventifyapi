...
namespace Eventify.Migrations
{
    ...
    [Migration("20200329194007_Add Photo Entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventify.Core.Domain.Photo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Eventify.Core.Domain.Photo", b =>
                {
                    b.HasOne("Eventify.Core.Domain.Event", null)
                        .WithMany("Photos")
                        .HasForeignKey("EventId");

                    b.HasOne("Eventify.Core.Domain.User", null)
                        .WithMany("Photos")
